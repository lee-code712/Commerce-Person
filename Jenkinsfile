def IMG = "192.168.100.12/commerce-yr/commerce-yr-person-img:person-"
    ...
    stage('Deploy App') {
      steps {
        script {
          ...
          sh "${KC} set image deployment/commerce-yr-person-v2 commerce-yr-person-v2=${IMG}${BUILD_NUMBER} -n commerce-yr"
          echo "Deploy App END"
        }
      }
    }
